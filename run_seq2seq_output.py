...
from utils.model_outputs import Seq2seqModelOutput
from utils.keras_models import Seq2seqModel
import numpy as np

'''
This script is used to get the validation and test F1 score on a trained seq2seq model. Validation and test F1-scores 
...
idx = np.load(data_folder + 'idx.npy')
data = sys.argv[3]
...
# model trainer
getoutput = Seq2seqModelOutput(data)
getoutput.ensembleoutput(x_val,y_val, x_test, y_test, model_folder, seq2seq.seq2seqModel, idx)